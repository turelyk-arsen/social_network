    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                {{-- <button type="button"
                    class="rounded-full bg-gray-50 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                ...
                <button type="button"
                    ...
                    @if ($newMessagesCount > 0)
                        <span
                            class="absolute top-0 right-0 inline-block w-4 h-4 bg-red-500 text-white text-sm leading-none text-center rounded-full">{{ $newMessagesCount }}</span>
                    @endif
                </button>
