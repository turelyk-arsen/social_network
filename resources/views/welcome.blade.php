...
<body class="antialiased">
    ...
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-sky-50 dark:bg-dots-lighter dark:bg-gray-500 selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
    ...
    {{-- <div class="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row tails-selected-element"
