<x-app-layout>
    ...
    <div>
        <div class="w-full h-32 bg-[]"></div>
        <div class="container mx-auto -mt-32">

            <div class="py-6 h-screen ">
                <div style="border-radius: 20px" class="flex border border-gray-200 rounded shadow-lg h-full">

                    <!-- Left -->
                    <div style="border-radius : 20px" class="w-1/3 border flex flex-col">
                        <!-- Header -->
                        <div style="border-top-left-radius : 20px"
                            class="py-2 px-3 bg-white flex flex-row justify-between items-center">
                            <div>
                        ...
                        <div class="py-2 px-2 bg-white">
                            <input type="text" class="w-full rounded  px-2 py-2 text-sm"
                                placeholder="Search or start new chat" />
                        </div>
                        <!-- Contacts -->
                        <div style="border-bottom-left-radius : 20px" class="bg-white flex-1 overflow-auto">
                            @foreach ($users as $user)
                                <a href="/chat/{{ $user->id }}">
                    ...
                    <!-- Right -->
                    <div style="border-radius : 20px" class="w-2/3 border flex flex-col">
                        ...
                        <!-- Messages -->
                        <div class="flex-1 overflow-auto bg-gradient-to-r from-purple-100 to-blue-100">
                            <div class="py-2 px-3">

                                <div class="flex justify-center mb-2">
                                    <div class="rounded py-2 px-4" style="background-color: white; border-radius: 5px">
                                ...
                                <div class="flex justify-center mb-4">
                                    <div class="rounded py-2 px-4"
                                        style="background-color: #fff9fe; border-radius: 5px">
                                        <p class="text-xs">
                        ...
                        <!-- Input -->
                        <div style="border-bottom-right-radius : 20px" class="bg-white px-4 py-4 flex items-center">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                    height="24">
                            ...
                            <div class="flex-1 mx-4">
                                <form action="/chat/send-message" method="post" class="mt-4">
                                    ...
                                    <div class="flex">
                                        <input type="hidden" name="to_user_id" value="{{ $to_user_id->id }}">
                                        <input type="hidden" name="from_user_id" value="{{ $from_user_id->id }}">
                                        <input type="text" name="content" class="w-full border rounded px-2 py-2"
                                            placeholder="Type a message">
                                        <button style="border-radius : 5px; background-color: #c8b5dd" type="submit"
                                            class=" text-white py-2 px-4 rounded-r-lg ml-2">Send</button>
                                    </div>
                                </form>
                            </div>
                            <div>
