    ...
    <div>
        ...
        <div class="container mx-auto -mt-32">
            ...
            <div class="py-6 h-screen ">
                <div style="border-radius: 20px" class="flex rounded shadow-lg h-full">
                    ...
                    <div class="w-1/3  flex flex-col">
                        ...
                        <!-- Search -->
                        <div class="py-2 px-2 border-r border-gray-300 ">
                            <input type="text" class="w-full px-2 py-2 text-sm rounded-xl "
                                placeholder="Search or start new chat" />
                        </div>
                        <!-- Contacts -->
                        <div class="border-r border-gray-300 bg-grey-900 flex-1 overflow-auto">
                            @foreach ($users as $user)
                                <a href="/chat/{{ $user->id }}">
                                        ...
                                        <div>
                                            <div class="relative">
                                                <img class="h-12 w-12 rounded-full"
                                                    src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('images/No_image_available.svg.png') }}" />
                                                @if (isset($unreadCount[$user->id]) && $unreadCount[$user->id] > 0)
                                                    <div
                                                        class="absolute top-0 left-10 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs">
                                                        {{ $unreadCount[$user->id] }}</div>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    <div class="w-2/3  flex flex-col">
                        ...
                        <!-- Header -->
                        <div style=" border-top-right-radius: 20px;  background-color: #8c84ff"
                            class="py-2 px-3 flex flex-row justify-between items-center text-white ">
                        ...
                        <!-- Messages -->
                        <div class="flex-1 overflow-auto" style="background-color: #f0efff">
                            <div class="py-2 px-3">
                                ...
                                <div class="flex justify-center mb-4">
                                    <div class="rounded py-2 px-4" style="background-color: #ffffff">
                                        <p class="text-xs">
                                    ...
                                    <form action="/chat/send-message" method="post" class="mt-4">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="hidden" name="from_user_id"
                                                value="{{ $from_user_id->id }}">
                                            <input type="text" name="content"
                                                class="w-full border rounded px-2 py-2" placeholder="Type a message">
                                            <button type="submit"
                                                class="bg-indigo-500 text-white py-2 px-4 rounded-r-lg ml-2">Send</button>
                                        </div>
                                    </form>
